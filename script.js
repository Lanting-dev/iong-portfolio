...
function updateMeteAnimation() {
  ...
  const productScale = transformRange(progress, [0, 0.075, 0.4, 0.5], [0.72, 1, 1, 0.74]);
  ...
  const capY = transformRange(progress, [0.16, 0.22, 0.32, 0.4], [0, 145, 240, 520]);
  const capX = transformRange(progress, [0.16, 0.22, 0.32, 0.4], [0, -32, -82, 460]);
  const capRotate = transformRange(progress, [0.16, 0.22, 0.32, 0.4], [0, -18, -34, 18]);
  const capOpacity = transformRange(progress, [0, 0.159, 0.16, 0.38, 0.41], [0, 0, 1, 1, 0]);

  const closedOpacity = transformRange(progress, [0, 0.159, 0.16], [1, 1, 0]);
  const openOpacity = transformRange(progress, [0, 0.159, 0.16, 0.38, 0.41], [0, 0, 1, 1, 0]);
  const bottleRotate = transformRange(progress, [0.18, 0.28, 0.32, 0.4], [0, 9, 14, 24]);
  const bottleX = transformRange(progress, [0.18, 0.32, 0.4], [0, 36, 520]);
  const bottleY = transformRange(progress, [0.32, 0.4], [0, -360]);

  const subOpacity = transformRange(progress, [0.24, 0.34, 0.52, 0.58], [0, 1, 1, 0]);
  const subY = transformRange(progress, [0.24, 0.4, 0.58, 1], [120, 260, 70, 70]);
  const subX = transformRange(progress, [0.24, 0.4, 0.58, 1], [0, -20, -300, -300]);
